...
<body>
    ...
    $connect->sql = "SELECT  product_name FROM  product  WHERE product_id  ='" . $_GET['id'] . "'";
    $connect->queryData();
    $rsconnect = $connect->fetch_AssocData();
    $product_name = $rsconnect['product_name'];
    ?>
    <!-- ======= Header ======= -->
    <?php
    ...
    <section id="material" class="material">
        ...
        <div class="text-center">
            <div class="container">
                <div class="row">
                    <?php
                    $connect->sql = "SELECT  * FROM  product  WHERE product_status =1  AND product_id='" . $_GET['id'] . "'";
                    $connect->queryData();

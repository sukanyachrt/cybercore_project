            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="py-3 mb-4"><span class="text-muted fw-light">ข้อมูลโปรโมชั่น</span></h4>
                        <div class="row">
                            <!-- Basic Layout -->
                            <div class="col-xxl">
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        <form id="producttypeForm">
                                            <div class="row mb-3">
                                                <label class="col-sm-2 col-form-label" for="promotion_id">รหัสโปรโมชั่น</label>
                                                <div class="col-sm-10 form-group">
                                                    <input type="text" class="form-control" ReadOnly id="promotion_id" name="promotion_id" placeholder="รหัสประเภทสินค้า" />
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                <label class="col-sm-2 col-form-label" for="promotion_name">ชื่อโปรโมชั่น	</label>
                                                <div class="col-sm-10 form-group">
                                                    <input type="text" class="form-control" id="promotion_name" name="promotion_name" placeholder="ชื่อโปรโมชั่น	" />
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                <label class="col-sm-2 col-form-label" for="promotion_discount">ราคาส่วนลด	</label>
                                                <div class="col-sm-10 form-group">
                                                    <input type="text" class="form-control" id="promotion_discount" name="promotion_discount" placeholder="ราคาส่วนลด	" />
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                <label class="col-sm-2 col-form-label" for="promotion_discount">วันที่เริ่มโปรโมชั่น	</label>
                                                <div class="col-sm-10 form-group">
                                                    <input type="text" class="form-control" id="promotion_discount" name="promotion_discount" placeholder="ราคาส่วนลด	" />
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                <label class="col-sm-2 col-form-label" for="promotion_discount">วันที่สิ้นสุดโปรโมชั่น	</label>
                                                <div class="col-sm-10 form-group">
                                                    <input type="text" class="form-control" id="promotion_discount" name="promotion_discount" placeholder="ราคาส่วนลด	" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-3">
                                            <label class="col-sm-2 col-form-label" for="protype_status">สินค้าที่ร่วมรายการ </label>
                                            </div>

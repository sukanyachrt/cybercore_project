            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="py-3 mb-0">ข้อมูลโปรโมชั่นสินค้า</h4>
                                            ...
                                            <table class="table table-bordered">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="text-center">วันที่เริ่ม-สิ้นสุดโปรโมชั่น	</th>
                                                        <th class="text-center">จำนวนสินค้าที่ร่วมรายการ	</th>
                                                        <th class="text-center">สถานะ</th>
                                                        <th class="text-center"></th>
                                                    </tr>
                                                </thead>
                                                <tbody id="tbproductpromotion">
...
<script>
    ...
    $("#search").on("keyup", function() {
        ...
        $("#tbproductpromotion tr").filter(function() {
    ...
    function dataProducttype() {
        ...
        xhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
                document.getElementById("tbproductpromotion").innerHTML = this.responseText;
